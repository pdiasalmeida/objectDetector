...
void FilesHelper::getFilesInDirectory( const std::string& dirName, std::vector< std::string >& fileNames,
...
bool FilesHelper::fileAvailable( std::string dirName, std::string fileName, std::vector< std::string >& validExtensions )
{
	bool result = false;
...
std::vector< std::string > FilesHelper::streamSplit( std::istringstream& instream, char delimiter )
{
	std::string token;
